...
impl MapElement {
    ...
    pub fn color_theme_standard(&self) -> Option<Rgb565> {
        Some(match self.element_type {
            ...
            ElementType::Residenziale => Rgb565::new(182 >> 3, 182 >> 2, 176 >> 3),
            ElementType::Commerciale => Rgb565::new(176 >> 3, 172 >> 2, 164 >> 3),
            ElementType::Industriale => Rgb565::new(145 >> 3, 146 >> 2, 148 >> 3),
            ElementType::Agricolo => Rgb565::new(155 >> 3, 255 >> 2, 120 >> 3),
            ElementType::Aeroporto => Rgb565::new(132 >> 3, 134 >> 2, 138 >> 3),
            ElementType::Cimitero => Rgb565::new(150 >> 3, 154 >> 2, 146 >> 3),
    ...
    pub fn color_theme_gta(&self) -> Option<Rgb565> {
        match self.element_type {
            ...
            ElementType::Residenziale => Some(Rgb565::new(158 >> 3, 157 >> 2, 162 >> 3)),
            ElementType::Commerciale => Some(Rgb565::new(158 >> 3, 157 >> 2, 162 >> 3)),
            ElementType::Industriale => Some(Rgb565::new(158 >> 3, 157 >> 2, 162 >> 3)),
            ElementType::Agricolo => Some(Rgb565::new(123 >> 3, 138 >> 2, 58 >> 3)),
            ElementType::Aeroporto => Some(Rgb565::new(158 >> 3, 157 >> 2, 162 >> 3)),
            ElementType::Cimitero => Some(Rgb565::new(158 >> 3, 157 >> 2, 162 >> 3)),
